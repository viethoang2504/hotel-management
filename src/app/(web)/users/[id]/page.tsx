...
const UserDetails = (props: { params: { id: string } }) => {
    ...
    const { data: userData, isLoading: loadingUserData, error: errorGettinUserData } = useSWR("/api/users", fetchUserData)

    if (error || errorGettinUserData) {
                    ...
                    <nav className="sticky top-0 px-2 w-fit mx-auto md:w-full md:px-5 py-3 mb-8 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 mt-7">
                        ...
                        >
                            ...
                            >
                                ...
                                <a className="inlifle items-center mx-1 md:mx-3 text-xs md:text-sm font-medium">
                                    Current Bookings
                                </a>
                            </li>
                        </ol>
